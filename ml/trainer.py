...
def train_and_save_model(model_path="ml/xgboost_sanket_model.pkl"):
    """Trains XGBoost model on synthetic severe weather dataset and serializes to disk."""
    try:
        import xgboost as xgb
        from ml.predictor import SanketWeatherPredictor
        
        predictor = SanketWeatherPredictor()
        X_train, y_train = predictor._generate_physics_training_data(n_samples=2000)
